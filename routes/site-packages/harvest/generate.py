...
class Generate():
  ...
  def gen_zip(self, project_id, by_name=True, workspace="/tmp", result_filename="photos_result.zip", needs_download_url=True, needs_include_hierarchy=False, needs_make_dir=True, char_enc="utf_8", needs_all_photos=False):
