...
class Generate():
  ...
  def gen_zip(self, project_id, by_name=True, workspace="/tmp", result_name="photos_result.zip", need_download_link=True):
  ...
  def gen_excel_doc(self, project_id, has_hierarchy=False, workspace="/tmp", template="basic_1.xlsx", result="photos_result.xlsx", need_download_link=True):
