...
class ExcelDocGenerator():
  ...
  def add_each_values(self, values, cells):
    for value in values:
      print(value)
  ...
  def generate(self, items, save_filename):
    ...
    print(images)
    self.add_each_images(images, image_cells)
    self.add_each_values(types, type_cells)
    self.add_each_values(names, name_cells)
