...
from harvest.exception import TemplateNotFoundError, TemplateMaxCountExceededError, TemplateTypeInvalidError, DuplicateTemplateNameExistsError, NeedsPropertyNotExistsError, PageBreaksCountInvalidError, SettingPropertyCountInvalid
...
class TemplateController():
  ...
  def validate(self, template_path, property_title, property_hierarchy, property_date):
    ...
    if len(excel.get_page_breaks(row_num_only=True)) not in [1, 2]:
