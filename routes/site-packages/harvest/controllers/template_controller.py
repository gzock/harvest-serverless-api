...
from harvest.exception import TemplateNotFoundError, TemplateMaxCountExceededError, TemplateTypeInvalidError, DuplicateTemplateNameExistsError, NeedsPropertyNotExistsError, PageBreaksCountInvalidError, SettingPropertyCountInvalid, PrintAreaNotExistsError
...
class TemplateController():
  ...
  def validate(self, template_path, property_title, property_hierarchy, property_date):
    ...
    for key, value in aggregate_cells.items():
      if len(value) != 1:
        raise SettingPropertyCountInvalid(key, len(value))
