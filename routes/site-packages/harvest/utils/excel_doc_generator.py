...
class ExcelDocGenerator():
  ...
  def copy_cells(self, src_row_min, src_row_max, dst_row_min):
    for index, row in enumerate(self.ws.iter_rows(min_row=src_row_min, max_row=src_row_max)):
      for cell in row:
        self.ws.cell(row=dst_row_min + index, column=cell.column).value = copy(cell.value)
        self.ws.cell(row=dst_row_min + index, column=cell.column).style = copy(cell.style)
        self.ws.cell(row=dst_row_min + index, column=cell.column).fill = copy(cell.fill)
        self.ws.cell(row=dst_row_min + index, column=cell.column).border = copy(cell.border)
        self.ws.cell(row=dst_row_min + index, column=cell.column).font = copy(cell.font)
        self.ws.cell(row=dst_row_min + index, column=cell.column).alignment = copy(cell.alignment)
        self.ws.row_dimensions[dst_row_min + index].height = copy(self.ws.row_dimensions[cell.row].height)
