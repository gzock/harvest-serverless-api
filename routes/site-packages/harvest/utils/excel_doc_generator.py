...
class ExcelDocGenerator():
  ...
  def copy_cells(self, src_row_min, src_row_max, dst_row_base, first_page_break_row, count):
  ...
  def generate(self, title, items, save_filename, needs_include_hierarchy=False, needs_date=False, needs_print_settings=False, workspace="/tmp"):
    ...
    copy_ranges = {"src_row_min": 1, "src_row_max": 2, "dst_row_base": 2, "first_page_break_row": page_breaks[0]}
